...
namespace MIssion06_Demars.Models
{
    public class Movie
    {
        ...
        [Range(1888, int.MaxValue, ErrorMessage = "Please input a valid year. The year must be greater than or equal to 1888.")] //set the year as required, and no year greater than 1888
        ...
        [Required(ErrorMessage = "Please input a value for Edited field")]
        public bool Edited { get; set; } //this field is required

        public string? LentTo { get; set; }

        [Required (ErrorMessage = "Please input a value for Copied To Plex")]
